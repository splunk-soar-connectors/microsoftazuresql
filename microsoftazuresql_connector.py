...
class MicrosoftAzureSqlConnector(BaseConnector):
    ...
    def _get_asset_name(self, action_result, phantom_base_url):
    ...
    def _get_app_rest_url(self, action_result):
        ...
        ret_val, asset_name = self._get_asset_name(action_result, phantom_base_url)
        if phantom.is_fail(ret_val):
            return action_result.get_status(), None
    ...
    def initialize(self):
        ...
        self._subscription = config[MS_AZURE_CONFIG_SUBSCRIPTION].encode('utf-8')
